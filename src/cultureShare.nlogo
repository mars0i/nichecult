...
<experiments>
  ...
  <experiment name="HouseRadius5" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="NoHouses" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count people with [culture &gt; 0]</metric>
  ...
  <experiment name="Speed01bothHouses1000ticks" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count people with [culture &gt; 0]</metric>
  ...
  <experiment name="Speed01NoHousesHighMultiplier025" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count people with [culture &gt; 0]</metric>
  ...
  <experiment name="Speed01NoHousesHighMultiplier03" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count people with [culture &gt; 0]</metric>
  ...
  <experiment name="Speed01NoHousesHighMultiplier02" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count people with [culture &gt; 0]</metric>
